...
Azure Red Hat OpenShift supports generally available (GA) minor versions of Red Hat OpenShift Container Platform for at least 14-months from when it became available as a stable release in OCP. In other words, an OpenShift version will be supported on Azure Red Hat OpenShift for at least 14 months from the date it became GA regardless of upgrade availability.
